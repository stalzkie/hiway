      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            ...
            print(auth.currentSession!.accessToken );
            applicationService.applyForJob(job_post_id: listingData!["job_post"]["job_post_id"],
                                           job_seeker_id: listingData!["job_seeker_id"],
                                           employer_id: listingData!["job_post"]["employer"]["employer_id"],
                                           bearerToken: auth.currentSession!.accessToken );
          },
